...
def muKtoJypersr(muK,f):
    """
    convert from muK units to Jy/sr based on 
    https://arxiv.org/pdf/1303.5070.pdf & https://arxiv.org/pdf/2010.16405.pdf
...
def muKtoJypersr_RJ(muK,f):
    """
    convert from muK units to Jy/sr using RJ limit approx
